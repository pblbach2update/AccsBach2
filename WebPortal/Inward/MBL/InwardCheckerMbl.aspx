<%@ Page Title="" Language="C#" MasterPageFile="~/Inward/InwardMenu.Master" AutoEventWireup="true"
    CodeBehind="InwardCheckerMbl.aspx.cs" Inherits="Accs.Web.Inward.MBL.InwardCheckerMbl"  %>
                        ...
                        <asp:GridView ID="gvbatch" runat="server" AutoGenerateColumns="False" Width="800px"
                            ...
                            <Columns >
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="/Inward/mbl/checkersingleitemprocess.aspx?chkno=<%# Eval("ChequeID")%>" ><%# Eval("ChequeSequence")%></a>
                                        </ItemTemplate>
                                </asp:TemplateField>
