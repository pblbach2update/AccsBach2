<%@ Page Title="" Language="C#" MasterPageFile="~/Inward/InwardMenu.Master" AutoEventWireup="true"
    CodeBehind="InwardMakerMbl.aspx.cs" Inherits="Accs.Web.Inward.MBL.InwardMakerMbl"  %>
                        ...
                        <asp:GridView ID="gvbatch" runat="server" AutoGenerateColumns="False" Width="800px"
                            ...
                            <Columns >
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="/Inward/Mbl/MakerSingleItemProcess.aspx?chkno=<%# Eval("ChequeID")%>" ><%# Eval("ChequeSequence")%></a>
                                        </ItemTemplate>
                                </asp:TemplateField>
