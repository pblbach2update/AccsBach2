<%@ Page Title="" Language="C#" MasterPageFile="~/Inward/InwardMenu.Master" AutoEventWireup="true"
    CodeBehind="inwardcheckerKrishi.aspx.cs" Inherits="Accs.Web.Inward.inwardcheckerKrishi"  %>
                        ...
                        <asp:GridView ID="gvbatch" runat="server" AutoGenerateColumns="False" Width="800px"
                            ...
                            <Columns >
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="/Inward/checkerprocessKrishi.aspx?chkno=<%# Eval("ChequeID")%>" ><%# Eval("ChequeSequence")%></a>
                                        </ItemTemplate>
                                </asp:TemplateField>
