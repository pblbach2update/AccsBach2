<%@ Page Title="" Language="C#" MasterPageFile="~/Inward/InwardMenu.Master" AutoEventWireup="true"
    CodeBehind="InwardMaker.aspx.cs" Inherits="Accs.Web.Inward.Basic.InwardMaker"  %>
                        ...
                        <asp:GridView ID="gvbatch" runat="server" AutoGenerateColumns="False" Width="800px"
                            ...
                            <Columns >
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <a href="/Inward/Basic/MakerSingleItemProcess.aspx?chkno=<%# Eval("ChequeID")%>" ><%# Eval("ChequeSequence")%></a>
                                        </ItemTemplate>
                                </asp:TemplateField>
