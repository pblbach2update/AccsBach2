<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakerProcessNRBNew.aspx.cs"
    Inherits="Accs.Web.Inward.NRB.MakerProcessNRBNew" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#chkZoomCheckFrontBack").click(function () {
                if ($(this).is(":checked")) {
                    $("#chqfront").loupe();
                    $("#chqrear").loupe();
                } else {
                    ...
                    <tr>
                        <td colspan="2">
                            <table style="width: 100%">
                                <tr>
                                    <td width="33%">
                                        <asp:Label ID="batchno" runat="server" Text="Label">Batch No</asp:Label>
                                    </td>
                                    <td align="right">
                    ...
                    <tr>
                        <td valign="top" style="width: 52%; padding-top: 10px; padding-left: 5px">
                            <div style="margin-bottom: 10px">
                                <asp:CheckBox ID="chkZoomCheckFrontBack" runat="server" Checked="false" Text="Enable Zoom" AutoPostBack="false"
                                    Visible="true" />
                            </div>
                            <div style="margin-bottom: 10px">
