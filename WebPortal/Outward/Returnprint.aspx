    ...
    <div style="">
        <div id="hinfo">
            <table width="600px">
                <tr>
                    <td align="right">
                        <a href="#" onclick="$('#hinfo').css('display','none');window.print();$('#hinfo').css('display','block') ">
                            Print</a> <a href="#" onclick="window.close();">Close</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <asp:TemplateField>
                    ...
                    <asp:HiddenField ID="batchno" Value='<%# Eval("BatchNo") %>' runat="server" />--%>
                        ...
                        <table cellpadding="4px" >
                            ...
                            <tr>
                                <td>
                                    <img alt="" src='<%# Eval("FrontImageUrl")  %>' height="260px" width="550px" style="border-width: 2px;
                                        border-style: solid" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img alt="" src='<%# Eval("BackImageUrl")  %>' height="260px" width="550px" style="border-width: 2px;
                                        border-style: solid" />
                                </td>
                            </tr>
                        </table>
