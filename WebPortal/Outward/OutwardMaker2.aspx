<%@ Page Title="" Language="C#" MasterPageFile="~/Outward/Outward.Master" AutoEventWireup="true"
    CodeBehind="OutwardMaker2.aspx.cs" Inherits="Accs.Web.Outward.OutwardMaker2" ValidateRequest="false" %>
                            ...
                            <div id="divBatchSelection" runat="server">
                                <asp:GridView ID="gvBatchList" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvBatchList_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Accepted" DataField="MakerAccept">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Rejected" DataField="MakerReject">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                ...
                                <div id="divNobatch" runat="server" style="text-align: center; padding: 20px;" visible="False">
                                    <asp:Label ID="label1" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#666666"
                                ...
                                <div style="width: 800px;">
                                    <table class="m_batch" cellpadding="0" cellspacing="0" style="margin: auto; width: 100%;">
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <asp:CheckBox ID="chkScanned" runat="server" Checked="True" Text="Unprocessed" CssClass="CheckBoxProcess" />
                                                <asp:CheckBox ID="chkMakerAccept" runat="server" Text="Accepted" CssClass="CheckBoxProcess"
                                                    Checked="True" />
                                                <asp:CheckBox ID="chkMakerReject" runat="server" Text="Rejected" CssClass="CheckBoxProcess"
                                                    Checked="True" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="td_alt" colspan="2">
                                                <asp:Label ID="lblBatchNo" runat="server" Font-Bold="false" Font-Size="16px" Text="0"></asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="count_val">
                                                <asp:Label ID="labelTotalAmount" runat="server" Font-Bold="True" Font-Size="16px"
                                                    Text="0"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="count_label td_alt">Maker Accepted:
                                            </td>
                                            <td class="count_val td_alt">
                                            ...
                                            <td class="count_label td_alt">Maker Rejected:
                                            </td>
                                            <td class="count_val td_alt">
                        ...
                        <td>
                            <div class="userBox">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound"
                                    ...
                                    OnPageIndexChanging="GridView1_PageIndexChanging" Width="800px" GridLines="None">
            ...
            <div id="divOWEditorContent" class="ModalCenter">
                        ...
                        <table id="table_body" style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <td class="dataEntry">
                                    <div id="grp_amount" class="no_notification" style="width: 280px">
                                        <fieldset>
                                            ...
                                            <div>
                                                <span>Amount</span>
                                                <input type="text" name="cu_amount" id="cu_amount" tabindex="2" maxlength="13" /><span
                                                    style="color: Red; font-size: 24px;">*</span>
                                                <br />
                                                <span id="cu_amount_p" class="invalid_entry" style="display: none;">(Invalid Amount)
                                                </span>
                                                <br />
                                                <span style="font-size: 13px" id="taka"></span>
                                            </div>
                                            <div>
                                                ...
                                                <cc1:CalendarExtender Format="dd/MM/yyyy" ID="CalendarExtender2" runat="server" TargetControlID="cu_date"
                                            ...
                                            <div id="remarks" class="no_notification" style="display: none; margin-top: 10px">
                                                <span style="float: left; padding-right: 10px">Remarks</span>
                                                <div>

                                                    <input type="text" class="eselect" style="border: 0; margin: 0" title="Govt to Public,Public to Govt"
                            ...
                            <tr>
                                <td class="dataEntry" rowspan="2">
                                    ...
                                    <%--<div id="remarks" class="no_notification" style="display: none;">
                                        <div>
                                            Remarks
                                        </div>
                                        <div>
                                    ...
                                    <div id="Div6" class="clearboth no_notification" style="padding: 5px; border: 0px solid rgb(204, 204, 153); margin-left: 5px; display: none;">
                                ...
                                <td class="chkInfo">
                                    <div id="grp_img_micr" class="no_notification">
                                        ...
                                        <div id="micr_div">
                                            ...
                                            <div>
                                                <a class="noborder" id="edit_micr" href="javascript:void(0)">Modify</a>
                                            </div>
                                        </div>
                ...
                <div style="clear: both; height: 32px;">
                    <div class="buttons">
                        ...
                        <button type="button" class="regular" id="front_image" name="front_image" tabindex="7">
                            <img src="/media/outward/textfield_key.png" alt="" />
                            Front
                        </button>
                        <button type="button" class="regular" id="rear_image" name="back_image" tabindex="8">
                            <img src="/media/outward/textfield_key.png" alt="" />
                            Back
                        </button>
                        ...
                        <button type="button" class="positive" id="prev" name="prev" tabindex="10">
                            <img src="/media/outward/apply.png" alt="" />
                            Previous
                        </button>
                        <button type="button" class="positive" id="next" name="next" tabindex="11">
                            <img src="/media/outward/apply.png" alt="" />
                            Next
                        </button>
