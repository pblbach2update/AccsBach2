<%@ Page Title="" Language="C#" MasterPageFile="~/Outward/Outward.Master" AutoEventWireup="true" CodeBehind="OutwardCollectionChecker.aspx.cs" Inherits="Accs.Web.Outward.NRB.OutwardCollectionChecker" %>
    ...
    <form runat="server">
        ...
        <div>
            ...
            <asp:GridView ID="gvFinaliezedItems" runat="server" AutoGenerateColumns="False" Width="800px"
                ...
                <Columns>
                    <asp:BoundField HeaderText="FtNo" DataField="CbsFtNo" />
