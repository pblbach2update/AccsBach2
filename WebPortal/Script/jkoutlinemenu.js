var jkoutlinemenu = {
    ...
    render: function($) {
        ...
        for (var i = 0, labels = this.outlinemenulabels[i]; i < this.outlinemenulabels.length; i++, labels = this.outlinemenulabels[i]) {
            ...
            //alert(this.outlinemenus[0].$anchorobj);
            //var data = eval(this.outlinemenus[0]);
            //alert(data['$anchorobj']);
            var outlinemenu = this.outlinemenus[i]
            outlinemenu.$anchorobj.add(outlinemenu.$menuobj).attr("_outlinemenupos", i)
