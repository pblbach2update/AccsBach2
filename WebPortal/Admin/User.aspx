            ...
            <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlOption" Font-Names="Trebuchet MS" Font-Size="10pt" runat="server"
                                    OnSelectedIndexChanged="ddlOption_SelectedIndexChanged" AutoPostBack="True">
                ...
                <div id="div2" runat="server">
                    <table cellpadding="0" cellspacing="4">
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="userBox" style="width: 600px;">
                                                ...
                                                <td>
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp; &nbsp;<asp:LinkButton runat="server" ID="lbSetUserLimit" OnClick="ShowUserLimit" Text="Set User Limit"></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="text-align: right; padding-right: 30px;">
                                                                <asp:Button ID="btnAdd" Font-Names="Trebuchet MS" Font-Size="10pt" runat="server"
                                                                    OnClick="btnAdd_Click" Text="Add User" />
                                                                &nbsp;&nbsp;&nbsp;
                ...
                <div id="div3" runat="server" visible="false">
                    <table cellpadding="0" cellspacing="4">
                        <tr>
                            <td>
                                <span class="headText2" style="margin-left: 0px;">List of Inactive Users</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div style="display: block; width: 600px;" class="userBox">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td colspan="2">
                                                <asp:GridView ID="gvInactive" runat="server" AutoGenerateColumns="False" CellPadding="6"
                                                    ForeColor="#333333" GridLines="None" Width="100%" OnRowDeleting="gvInactive_RowDeleting">
                                                    <RowStyle BackColor="#FFFFFF" ForeColor="#333333" />
                                                    <Columns>
                                                        <asp:CommandField DeleteText="Activate" ShowDeleteButton="True" />
                                                        <asp:BoundField DataField="Username" HeaderText="Username">
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="EmployeeName" HeaderText="Employee Name">
