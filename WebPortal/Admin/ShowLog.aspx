    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="gvLog" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="LogDate" HeaderText="Time">
                        <ItemStyle HorizontalAlign="Center" Width="200px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="LoggedBy" HeaderText="User">
                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="OperationTyee" HeaderText="Type">
                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                </Columns>
