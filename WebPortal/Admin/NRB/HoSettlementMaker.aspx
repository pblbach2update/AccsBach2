<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/ControlPanel.Master" AutoEventWireup="true" CodeBehind="HoSettlementMaker.aspx.cs" Inherits="Accs.Web.Admin.NRB.HoSettlementMaker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_ControlPanel" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <div>
            Not Settled :<asp:Label runat="server" ID="lbNotSettled"></asp:Label>
